          ...
          <div class="box box-primary">
            ...
            <form role="form">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Connection ID</label>
                  <input type="text" class="form-control" id="connectionID" placeholder="Enter connection ID">
                </div>
                <div class="form-group">
...
<script>
	...
	function saveViaAjax() {
		...
		$.ajax({
			...
			data : {connectionID:search["connectionID"],date:search["date"],amount:search["amount"]},
			dataType : 'text',
			timeout : 100000,
