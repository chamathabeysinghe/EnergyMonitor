...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
 	...
 	if (bills.size() <= 0) {
 		...
 		for (Bill bill : bills) {
 			out.println(
 					"<div class=card card-inverse card-primary text-xs-center style=background-color: #333; border-color: #333;>"
 							...
 							+ "<label class= col-sm-8 label>" + bill.getUsage() + "</label>" + " </div>"
 							+ " <div class=row>" + "<label class= col-sm-4 label label-primary>Amount</label>"
 							+ "<label class= col-sm-8 label>" + bill.getAmount() + "</label>" + " </div>" +
